...
- **Languages:** Python (Primary), SQL, Dart, javascript(basics)
- **AI/ML:** PyTorch, Scikit-learn, LangChain, RAG, Local LLMs (Ollama/Llama)
- **Tools & Platforms:** Git, GitHub, Docker, Power BI
- **Web:** HTML, CSS
